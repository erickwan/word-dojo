...
- **Words** load live from a [Google Sheet](https://docs.google.com/spreadsheets/d/190c37nH4QqdHu7QLtROKx7KDNq_FQhCkDU6jOFRKs54/edit?gid=1376137610) (columns: Word, Part of speech, Meaning, Synonym, Antonym, Example sentence). Add rows there and they appear on the next page load. Rows without a Meaning are skipped, and the Progress tab reports how many are waiting.
...
- **Progress tab**: mastery and struggle summary, searchable/filterable word list, per-word accuracy and levels, session history, accuracy by question type.
